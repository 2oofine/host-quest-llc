  ...
  return (
    <section className="relative w-full h-screen">
      ...
      <div className="px-5 md:px-0 container absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center lg:text-left w-full text-white z-20">
        {/* Title */}
        <motion.div
          className="mt-28 mb-5 md:mt-0 md:space-y-3 "
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <p className="my-5 text-base md:text-xl font-thin container lg:text-left lg:w-[63%] w-full">
            ...
            recruitment agency, we provide tailored workforce solutions that streamline hiring, enhance productivity,
            and drive long-term success for both job seekers and employers.
          </p>
        </motion.div>
