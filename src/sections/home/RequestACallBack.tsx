...
const RequestACallBack = () => {
  return (
    <section className="relative overflow-hidden w-full min-h-screen mt-32 pb-32">
      ...
      <div className="relative container mb-10 mt-10 lg:mb-0 lg:mt-0 2xl:mx-auto xl:mx-[155px] z-20 text-white pt-2 lg:pt-8 flex flex-col items-center text-center xl:items-start lg:text-left px-5">
