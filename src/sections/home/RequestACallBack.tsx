...
const RequestACallBack = () => {
  return (
    <section className="relative overflow-hidden w-full min-h-screen lg:h-screen mt-32">
      ...
      <div className="relative container mb-10 mt-10 lg:mb-0 lg:mt-0 2xl:mx-auto lg:mx-[155px] z-20 text-white pt-2 lg:pt-8 flex flex-col items-center text-center lg:items-start lg:text-left px-5">
